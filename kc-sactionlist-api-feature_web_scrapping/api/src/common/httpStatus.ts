export const HttpStatus = {
  ...
  STATUS_YOO_MANY_REQUEST: 429,
  STATUS_REQUEST_HEADER_FIELD_TOO_LARGE: 431,
  STATUS_CONNECTION_CLOSED_WITHOUT_RESPONSE: 444,
  ...
  STATUS_NETWORK_CONNECTION_TIMEDOUT_ERROR: 599,
};
